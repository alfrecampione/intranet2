...
//   data.agency = agency;
//   data.ld_nb_prem = production[0].premium
//     ? production[0].premium.substring(0, production[0].premium.length - 3)
//     : "$0";
//   data.ld_nb_pol = production[0].policies;
//   data.ld_rn_prem = production[1].premium
//     ? production[1].premium.substring(0, production[1].premium.length - 3)
//     : "$0";
//   data.ld_rn_pol = production[1].policies;
//   data.ld_rw_prem = production[2].premium
//     ? production[2].premium.substring(0, production[2].premium.length - 3)
//     : "$0";
//   data.ld_rw_pol = production[2].policies;
//   data.ld_tot_prem = production[3].premium
//     ? production[3].premium.substring(0, production[3].premium.length - 3)
//     : "$0";
...
//   data.lm_rn_prem = production[1].premium
//     ? production[1].premium.substring(0, production[1].premium.length - 3)
//     : "$0";
//   data.lm_rn_pol = production[1].policies;
//   data.lm_rw_prem = production[2].premium
//     ? production[2].premium.substring(0, production[2].premium.length - 3)
//     : "$0";
//   data.lm_rw_pol = production[2].policies;
//   data.lm_tot_prem = production[3].premium
//     ? production[3].premium.substring(0, production[3].premium.length - 3)
//     : "$0";
//   data.lm_tot_pol = production[3].policies;

//   production = (await pool.query(`SELECT * from intranet.agency_company_today`))
//     .rows;

//   data.ct_nb_prem = production[0].premium
//     ? production[0].premium.substring(0, production[0].premium.length - 3)
//     : "$0";
//   data.ct_nb_pol = production[0].policies;
//   data.ct_rn_prem = production[1].premium
//     ? production[1].premium.substring(0, production[1].premium.length - 3)
//     : "$0";
//   data.ct_rn_pol = production[1].policies;
//   data.ct_rw_prem = production[2].premium
//     ? production[2].premium.substring(0, production[2].premium.length - 3)
//     : "$0";
//   data.ct_rw_pol = production[2].policies;
//   data.ct_tot_prem = production[3].premium
//     ? production[3].premium.substring(0, production[3].premium.length - 3)
//     : "$0";
...
//   data.cm_nb_prem = production[0].premium
//     ? production[0].premium.substring(0, production[0].premium.length - 3)
//     : "$0";
//   data.cm_nb_pol = production[0].policies;
//   data.cm_rn_prem = production[1].premium
//     ? production[1].premium.substring(0, production[1].premium.length - 3)
//     : "$0";
//   data.cm_rn_pol = production[1].policies;
//   data.cm_rw_prem = production[2].premium
//     ? production[2].premium.substring(0, production[2].premium.length - 3)
//     : "$0";
//   data.cm_rw_pol = production[2].policies;
//   data.cm_tot_prem = production[3].premium
//     ? production[3].premium.substring(0, production[3].premium.length - 3)
//     : "$0";
...
//   let result = (await pool.query(`SELECT * FROM intranet.agency_csr_last_week`))
//     .rows;

//   data.franchises_best_last_week = result[0];
//   data.franchises_best_last_week.carriers = (
//     await pool.query(
//       `SELECT * FROM intranet.agency_carriers_last_week_franchise($1)`,
//       [data.franchises_best_last_week.csr],
//     )
//   ).rows;
//   data.franchises_second_last_week = result[1];
//   data.franchises_second_last_week.carriers = (
//     await pool.query(
//       `SELECT * FROM intranet.agency_carriers_last_week_franchise($1)`,
//       [data.franchises_second_last_week.csr],
//     )
//   ).rows;
//   data.franchises_third_last_week = result[2];
//   data.franchises_third_last_week.carriers = (
//     await pool.query(
//       `SELECT * FROM intranet.agency_carriers_last_week_franchise($1)`,
//       [data.franchises_third_last_week.csr],
//     )
//   ).rows;
...
//   data.agencies_today = (
//     await pool.query(
//       `SELECT * From intranet.agency_total_sales_daily_by_locations`,
//     )
//   ).rows;
...
//   result = await pool.query(`SELECT * FROM intranet.dashboard_agencies`);
...
//           "" + data.dashboard_location[i].id_location + ".png";
//       }
...
//       data.dashboard_location[i].output =
...
//   result = await pool.query(`SELECT * FROM intranet.dashboard_company`);
...
//           "" + data.dashboard_company[i].id_company + ".png";
//       }
...
//       states = ["success", "danger", "warning", "info", "primary", "secondary"];
//       state = states[stateNum];
//       data.dashboard_company[i].output =
//         '<span class="avatar-initial rounded-circle bg-label-' +
//         state +
//         '">NLA</span>';
//     }
