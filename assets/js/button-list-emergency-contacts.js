document.addEventListener("DOMContentLoaded", function () {
  ...
  function updateContactAttributes() {
    const allEntries = contactsContainer.querySelectorAll(
      ".emergency-contact-entry:not(.emergency-contact-template)"
    );
    allEntries.forEach((entry, index) => {
      ...
      secondaryPhoneInput.previousElementSibling.setAttribute(
        "for",
        secondaryPhoneInput.id
      );
    });
  }
